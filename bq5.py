...
delivered_table_spec = 'modular-asset-332406:dataset_food_orders_latest1.delivered_orders'
#project-id:dataset_id.table_id
other_table_spec = 'modular-asset-332406:dataset_food_orders_latest1.other_status_orders'
...
view_name = "daily_food_orders11"
dataset_ref = client.dataset('dataset_food_orders_latest')
view_ref = dataset_ref.table(view_name)
view_to_create = bigquery.Table(view_ref)

view_to_create.view_query = 'select * from `modular-asset-3324065.dataset_food_orders_latest.delivered_orders` where _PARTITIONDATE = DATE(current_date())'
